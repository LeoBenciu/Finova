...
const AccountCodeSelector: React.FC<AccountCodeSelectorProps> = ({ onSelect, onCancel, isLoading, language }) => {
  ...
  const allAccounts = [
    ...
    { code: '413', name: 'Efecte de incasat' },
    { code: '418', name: 'Clienti - facturi de intocmit' },
    { code: '419', name: 'Clienti - creditori' },
    { code: '421', name: 'Personal - salarii datorate' },
    { code: '423', name: 'Personal - avansuri de salarii' },
    { code: '424', name: 'Personal - alte creante si datorii' },
    { code: '426', name: 'Personal - depuneri pentru concedii' },
    { code: '427', name: 'Personal - alte depuneri' },
    { code: '428', name: 'Personal - alte operatiuni' },
    ...
    { code: '444', name: 'Impozite si taxe' },
    { code: '445', name: 'Subventii guvernamentale' },
    { code: '446', name: 'Alte impozite, taxe si varsaminente asimilate' },
    { code: '447', name: 'Fonduri speciale - taxe si varsaminente asimilate' },
    { code: '448', name: 'Alte impozite si taxe in curs de clarificare' },
    { code: '451', name: 'Sume datorate actionarilor' },
    { code: '452', name: 'Sume datorate asociatilor si membrilor' },
    { code: '453', name: 'Dividende de plata' },
    { code: '456', name: 'Asociatii - conturi curente' },
    { code: '457', name: 'Actionarii - conturi curente' },
    { code: '458', name: 'Actionarii - capital subscris si nevarsat' },
    { code: '461', name: 'Debitori diversi' },
    { code: '462', name: 'Creditori diversi' },
    { code: '463', name: 'Creante reprezentand dividende repartizate' },
    { code: '471', name: 'Cheltuieli inregistrate in avans' },
    { code: '472', name: 'Venituri inregistrate in avans' },
    { code: '473', name: 'Cheltuieli de constatat' },
    { code: '474', name: 'Venituri de constatat' },
    { code: '475', name: 'Decontari din operatiuni in participatie' },
    { code: '481', name: 'Cheltuieli de repartizat pe mai multe exercitii' },
    { code: '491', name: 'Ajustari pentru deprecierea creantelor - clienti' },
    { code: '495', name: 'Ajustari pentru deprecierea altor creante' },
    ...
    { code: '507', name: 'Bonuri de tezaur' },
    { code: '508', name: 'Alte valori mobiliare si creante asimilate' },
    { code: '511', name: 'Cecuri de incasat' },
    { code: '512', name: 'Conturi la banci in lei' },
    { code: '513', name: 'Conturi la banci in valuta' },
    { code: '518', name: 'Dobanzile de incasat' },
    { code: '519', name: 'Versaminete de efectuat' },
    { code: '531', name: 'Casa in lei' },
    { code: '532', name: 'Casa in valuta' },
    { code: '541', name: 'Acreditive' },
    { code: '542', name: 'Efecte scontate neajunse la scadenta' },
    { code: '581', name: 'Viramente interne' },
    { code: '59', name: 'Ajustari pentru pierderea de valoare a conturilor de trezorerie' },
    ...
    { code: '6022', name: 'Cheltuieli cu combustibilii' },
    { code: '6023', name: 'Cheltuieli cu materialele pentru ambalat' },
    { code: '6024', name: 'Cheltuieli cu piesele de schimb' },
    { code: '603', name: 'Cheltuieli privind obiectele de inventar' },
    { code: '604', name: 'Cheltuieli cu materialele nestocate' },
    { code: '605', name: 'Cheltuieli cu energia si apa' },
    { code: '606', name: 'Cheltuieli cu animalele si plantatiile' },
    { code: '607', name: 'Cheltuieli privind marfurile' },
    { code: '608', name: 'Cheltuieli cu ambalajele' },
    { code: '609', name: 'Reduceri comerciale primite' },
    { code: '621', name: 'Cheltuieli cu colaboratorii' },
    { code: '622', name: 'Cheltuieli cu remuneratiile personalului' },
    { code: '623', name: 'Cheltuieli cu indemnizatiile de delegare' },
    { code: '624', name: 'Cheltuieli cu primele de asigurare' },
    { code: '625', name: 'Cheltuieli cu deplasarile' },
    { code: '626', name: 'Cheltuieli cu pregatirea personalului' },
    { code: '627', name: 'Cheltuieli cu asigurarile si protectia sociala' },
    { code: '628', name: 'Alte cheltuieli cu personalul' },
    { code: '635', name: 'Cheltuieli cu alte impozite, taxe si varsaminete asimilate' },
    { code: '641', name: 'Cheltuieli cu amortizarile' },
    { code: '651', name: 'Cheltuieli din operatiuni de fiducie' },
    { code: '654', name: 'Cheltuieli din creante si debite' },
    { code: '655', name: 'Cheltuieli din diferente de curs valutar' },
    { code: '658', name: 'Alte cheltuieli de exploatare' },
    { code: '661', name: 'Cheltuieli privind dobanzile' },
    { code: '664', name: 'Cheltuieli privind diferentele nefavorabile de curs de schimb' },
    { code: '665', name: 'Cheltuieli privind diferentele de curs de schimb' },
    { code: '667', name: 'Cheltuieli din diferente de curs valutar' },
    { code: '668', name: 'Alte cheltuieli financiare' },
    { code: '671', name: 'Cheltuieli exceptionale' },
    { code: '681', name: 'Cheltuieli de exploatare privind amortizarile, provizioanele si ajustarile pentru depreciere sau pierdere de valoare' },
    { code: '686', name: 'Cheltuieli financiare privind amortizarile, provizioanele si ajustarile pentru depreciere sau pierdere de valoare' },
    { code: '691', name: 'Cheltuieli cu impozitul pe profit' },
    
    // Clasa 7 - Venituri
    { code: '701', name: 'Venituri din vanzarea produselor finite' },
    { code: '704', name: 'Venituri din vanzarea marfurilor' },
    { code: '705', name: 'Venituri din prestari de servicii' },
    { code: '706', name: 'Venituri din prestari de servicii' },
    { code: '707', name: 'Venituri din vanzarea produselor agricole' },
    { code: '708', name: 'Venituri din activitatea anexa' },
    { code: '711', name: 'Variatia stocurilor de produse' },
    { code: '721', name: 'Productia imobilizata' },
    { code: '741', name: 'Venituri din subventii de exploatare' },
    { code: '754', name: 'Venituri din creante si debite' },
    { code: '755', name: 'Venituri din diferente de curs valutar' },
    { code: '758', name: 'Alte venituri din exploatare' },
    { code: '761', name: 'Venituri din dobinzi' },
    { code: '762', name: 'Venituri din diferente de curs de schimb' },
    { code: '765', name: 'Venituri din diferente de curs de schimb valutar' },
    { code: '766', name: 'Venituri din diferente de curs valutar' },
    { code: '767', name: 'Venituri din diferente favorabile de curs de schimb' },
    { code: '768', name: 'Alte venituri financiare' },
    { code: '771', name: 'Venituri exceptionale' },
    { code: '781', name: 'Venituri din provizioane si ajustari pentru depreciere privind activitatea de exploatare' },
    { code: '786', name: 'Venituri din provizioane si ajustari pentru depreciere privind activitatea financiara' },
