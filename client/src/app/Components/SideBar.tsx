import { House, Settings, CloudUpload, FileStack, FileChartColumn, LogOut, ChevronDown, LucideAngry } from 'lucide-react';
...
const SideBar = () => {
  ...
  return (
    <div className='bg-[var(--primary-foreground)] min-w-[16rem] max-w-[16rem] min-h-screen p-4 relative'>
