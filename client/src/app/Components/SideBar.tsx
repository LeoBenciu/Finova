...
const SideBar = () => {
  ...
  return (
    <div className='bg-[var(--primary-foreground)] min-w-64 max-w-64 min-h-screen p-4 relative'>
      ...
      <button className='absolute bottom-10 left-0 bg-transparent focus:text-[var(--primary)] text-[var(--primaryText)] px-6
      min-w-full max-h-9 flex flex-row items-center gap-3 text-xl cursor-pointer hover:text-red-500'
      onClick={()=>logout()}>
