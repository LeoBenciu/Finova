import { House, Settings, CloudUpload, FileStack, FileChartColumn, LogOut, ChevronDown, Building, Landmark, ListChecks, Download } from 'lucide-react';
...
const SideBar = () => {
  ...
  return (
    ...
    rounded-xl'>
      ...
      hover:bg-[var(--primary)] text-[var(--primaryText)] px-3
      min-w-full max-h-9 flex flex-row items-center gap-3 text-base mb-2 cursor-pointer'
      onClick={()=>navigate('/exports')}><Download size={19}/> {language==='ro'?'Exporturi':'Exports'}</button>
